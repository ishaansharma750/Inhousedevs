...
const Roles = () => {
  ...
  let data = [
    {
      roleName: "Jenny Wilson",
      noOfUsers: "jennywilson123@gmail.com",
      action: {
        one: "view",
        two: "edit",
      },
    ...
    <>
      <div className="admin-container">
        <div className="admin-left">
          ...
          <hr />
          <br />
          <p className="routes">Admin Management</p>
          ...
          <p className="routes" onClick={handleLogout}>Logout</p>
        </div>

        <div className="admin-right">
          <div style={divStyle} className="admin-management">
            <h2 className="admin-1">Role Management</h2>
            <div className="admin-5">
              ...
              <span className="admin-3"> Role Management</span>
            </div>
          </div>
          ...
          <table>
            ...
            <tbody>
              {data.map((item, index) => {
                return (
                  <tr>
                    <td className="table-img">{item.roleName}</td>
                    <td>{item.noOfUsers}</td>
                    <td className="action-tab-roles">
